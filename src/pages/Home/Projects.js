...
const Projects = ({ data }) => {
    ...
    return (
        <div className="bg-[#1b5982] w-full sm:h-auto lg:h-screen md:h-screen flex">
            <div className="  flex flex-col w-1/2 sm:hidden sm:mt-10 sm:text-center justify-center  ">
                {selectedElement && (
                    <div className='bg-slate-200 h-3/4 overflow-y-auto no-scrollbar p-8 rounded-r-md ml-0 shadow-lg hover:shadow-2xl hover:bg-gray-200 cursor-pointer'>
